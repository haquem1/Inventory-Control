...
function create_editable_box(element, data, identifiers) {
    ...
    if (category == "name") {
        var box = '<input placeholder="' + data + '" id="editable-box" type="text" length="250" class="validate">';
        ...
        var box = '<input placeholder="' + data + '" id="editable-box" type="text" length="500" class="validate">';
        submit(box, element, data, identifiers);
    } else {
        var box = '<input placeholder="' + data + '" id="editable-box" type="number" class="validate">';
        submit(box, element, data, identifiers);
    }
}
...
function submit(box, element, data, identifiers) {
    ...
    // this only works for the select (category menu) items (not working for now)
