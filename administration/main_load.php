...
?>
	...
	<body>
		...
		<div class="row">
			...
			<!--|||CURRENT SECTION 		 			 -->
			<!--|||||||||||||||||||||||||||||||||||||-->
			<div class="col s12 m4 current">
				<div class="card medium hoverable current">
			...
			<!--|||INVENTORY SECTION 	 			 -->
			<!--|||||||||||||||||||||||||||||||||||||-->
			<div class="col s12 m4 inventory">
				<div class="card medium hoverable inventory">
					<div class="card-image waves-effect waves-block waves-light">
